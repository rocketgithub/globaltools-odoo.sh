...
class AcruxChatConversation(models.Model):
    ...
    def conversation_verify(self):
        ...
        self.env.cr.commit()
        if sctx:
            sctx.env['acrux.chat.conversation.activities']._gc_generic()
    ...
    def parse_message_receive(self, connector_id, message):
        ...
        if connector_id.connector_type in ['apichat.io', 'chatapi'] and message.get('id', False):
